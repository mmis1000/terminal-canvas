/**
 * Copyright (c) 2021 Mmis1000<mmis1000@yahoo.com.tw> All rights reserved.
 * @license MIT
 */
...
function fill<T extends TypedArray>(typed: T, value: number, start?: number, end?: number) {
    typed.fill(value, start, end) as T
}
